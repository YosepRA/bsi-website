module.exports = {
  ...
  about: {
    ...
    partnership: {
      title: 'Partnership',
      body: [
        'We are happy and proud to partner with such a wide spectrum of organizations that are so supportive of our company. Our partners have made a commitment to contribute more than financial support by contributing their joint ideas and resources to assist us strengthen and expand our business as a family.',
      ],
    },
  },
  contact: {
    banner: {
      title: 'Contact Us',
      body: 'Have any questions? We&apos;d love to hear from you.',
    },
  },
  exchange: {
    title: 'Exchange',
    ...
    exchangeList: [
      {
        ...
        body: [
          'DigiFinex is a Cryptocurrency trading platform and currently has more than 4 million users globally. This digital coin trading platform offers perpetual swaps, purchasing digital coins using a credit card, and leverage trading.',
